...
<form id="queryForm" action="<%=path %>/oni/mpcenterQuery.action" method="post">

	<s:if test="%{mpcenter.beginIndex!=null}">
 		<input type="hidden" id="beginIndex" value='<s:property value="mpcenter.beginIndex"/>' name="mpcenter.beginIndex"/>
	</s:if>
 	<s:else>
 		<input type="hidden" id="beginIndex" value='1' name="mpcenter.beginIndex"/>
 	</s:else>
    ...
    <div class="box span10 oh">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="list_table CRZ" id="CRZ0">
            ...
            <tr>
                ...
                <th style="width: 100px;">门店工资单价</th>
                                                
                <th style="width: 100px;">服务师单价</th>
                                                
                <th style="width: 100px;">培训中心名称</th>
                                                
                <th style="width: 100px;">培训中心地址</th>
                                                
                <th style="width: 100px;">区域</th>
                                                
                <th style="width: 100px;">联系方式</th>
                                                
                <th style="width: 100px;">父级编码</th>
                                     
            </tr>
            <s:iterator value="mpcenterList" id="mpcenter">
           	<tr class="tr" style="background-color: rgb(255, 255, 255);">
                <td class="td_center"><input type="checkbox" name="selectCheckbox" value='<s:property value="#mpcenter.tid"/>'></td>
                                                                
                <td><s:property value="#mpcenter.mname"></s:property></td>
                                                
                <td><s:property value="#mpcenter.maddress"></s:property></td>
                                                
                <td><s:property value="#mpcenter.mdj"></s:property></td>
                                                
                <td><s:property value="#mpcenter.fwsdj"></s:property></td>
                                                
                <td><s:property value="#mpcenter.pname"></s:property></td>
                                                
                <td><s:property value="#mpcenter.paddress"></s:property></td>
                                                
                <td><s:property value="#mpcenter.quyu"></s:property></td>
                                                
                <td><s:property value="#mpcenter.phone"></s:property></td>
                                                
                <td><s:property value="#mpcenter.pid"></s:property></td>
...
<div id="w" class="easyui-window" title="表单提交" data-options="modal:true,closed:true,iconCls:'icon-save'"
    ...
    <iframe id="frameframe" src="<%=path%>/page/mpcenterManager/mpcenteradd.jsp" style="width: 100%; height: 100%"></iframe>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn_add").bind({
            click: function () {
            	$("#frameframe").attr("src","<%=path%>/page/mpcenterManager/mpcenteradd.jsp");
                $('#w').window('open');
            }
        });
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#frameframe").attr("src","<%=path%>/oni/mpcenterEdit.action?mpcenter.tid="+selectId);
           	                $('#w').window('open');
           		       }
           			});
           		}
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#queryForm").attr("action","<%=path %>/oni/mpcenterDeleteDone.action?mpcenter.tid="+selectId);
           		        	$("#queryForm").submit();
           		       }
           			});
           		}
