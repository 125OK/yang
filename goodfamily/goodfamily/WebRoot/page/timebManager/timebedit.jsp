...
<head lang="en">
  ...
  <body>
    <form class="form-horizontal" action="<%=path %>/oni/timebEditDone.action" method="post">
    	    	
    	<input type="hidden" name="timeb.tid" value='<s:property value="#timeb.tid"/>'/>
    	    	    	    	    	    	            	
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">时间</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="sj" placeholder="时间" name="timeb.sj" value='<s:property value="#timeb.sj"/>'/>
            </div>
        </div>
