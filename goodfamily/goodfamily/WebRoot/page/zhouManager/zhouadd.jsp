...
<head lang="en">
  ...
  <body>
    <form class="form-horizontal" action="<%=path %>/oni/zhouAddDone.action" method="post">
    	    	            	
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">周几</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="zhouji" placeholder="用户名称" name="zhou.zhouji"/>
            </div>
        </div>
