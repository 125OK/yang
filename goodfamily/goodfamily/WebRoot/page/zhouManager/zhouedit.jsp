...
<head lang="en">
  ...
  <body>
    <form class="form-horizontal" action="<%=path %>/oni/zhouEditDone.action" method="post">
    	    	
    	<input type="hidden" name="zhou.tid" value='<s:property value="#zhou.tid"/>'/>
    	    	    	    	    	    	            	
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">周几</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="zhouji" placeholder="周几" name="zhou.zhouji" value='<s:property value="#zhou.zhouji"/>'/>
            </div>
        </div>
