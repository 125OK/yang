...
<head lang="en">
  ...
  <body>
    <form class="form-horizontal" action="<%=path %>/oni/fwsTimeAddDone.action" method="post">
    	    	            	
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">服务师编号</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="fwsId" placeholder="用户名称" name="fwsTime.fwsId"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="zhouId" placeholder="用户名称" name="fwsTime.zhouId"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="timebId" placeholder="用户名称" name="fwsTime.timebId"/>
            </div>
        </div>
