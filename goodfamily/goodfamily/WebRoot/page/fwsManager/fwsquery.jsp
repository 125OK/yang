...
<form id="queryForm" action="<%=path %>/oni/fwsQuery.action" method="post">

	<s:if test="%{fws.beginIndex!=null}">
 		<input type="hidden" id="beginIndex" value='<s:property value="fws.beginIndex"/>' name="fws.beginIndex"/>
	</s:if>
 	<s:else>
 		<input type="hidden" id="beginIndex" value='1' name="fws.beginIndex"/>
 	</s:else>
    ...
    <div class="box span10 oh">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="list_table CRZ" id="CRZ0">
            ...
            <tr>
                ...
                <th style="width: 100px;">属相</th>
                                                
                <th style="width: 100px;">精通语言</th>
                ...
                <th style="width: 100px;">薪资要求</th>
                                                
                <th style="width: 100px;">身份证号</th>
                                                
                <th style="width: 100px;">身份证地址</th>
                                                
                <th style="width: 100px;">工作类型</th>
                                                
                <th style="width: 100px;">经验介绍</th>
                                                
                <th style="width: 100px;">专业特长</th>
                                                
                <th style="width: 100px;">性格特点</th>
                                                
                <th style="width: 100px;">备注</th>
                                     
            </tr>
            <s:iterator value="fwsList" id="fws">
           	<tr class="tr" style="background-color: rgb(255, 255, 255);">
                <td class="td_center"><input type="checkbox" name="selectCheckbox" value='<s:property value="#fws.tid"/>'></td>
                                                                
                <td><s:property value="#fws.name"></s:property></td>
                                                
                <td><s:property value="#fws.age"></s:property></td>
                                                
                <td><s:property value="#fws.sex"></s:property></td>
                                                
                <td><s:property value="#fws.gjy"></s:property></td>
                                                
                <td><s:property value="#fws.xdz"></s:property></td>
                                                
                <td><s:property value="#fws.phone"></s:property></td>
                                                
                <td><s:property value="#fws.jiguan"></s:property></td>
                                                
                <td><s:property value="#fws.birthday"></s:property></td>
                                                
                <td><s:property value="#fws.mz"></s:property></td>
                                                
                <td><s:property value="#fws.sx"></s:property></td>
                                                
                <td><s:property value="#fws.yuyan"></s:property></td>
                                                
                <td><s:property value="#fws.shengao"></s:property></td>
                                                
                <td><s:property value="#fws.tizhong"></s:property></td>
                                                
                <td><s:property value="#fws.xl"></s:property></td>
                                                
                <td><s:property value="#fws.zs"></s:property></td>
                                                
                <td><s:property value="#fws.lx"></s:property></td>
                                                
                <td><s:property value="#fws.state"></s:property></td>
                                                
                <td><s:property value="#fws.money"></s:property></td>
                                                
                <td><s:property value="#fws.sfzh"></s:property></td>
                                                
                <td><s:property value="#fws.sfzdz"></s:property></td>
                                                
                <td><s:property value="#fws.gzlx"></s:property></td>
                                                
                <td><s:property value="#fws.des"></s:property></td>
                                                
                <td><s:property value="#fws.techang"></s:property></td>
                                                
                <td><s:property value="#fws.xgtd"></s:property></td>
                                                
                <td><s:property value="#fws.remark"></s:property></td>
...
<div id="w" class="easyui-window" title="表单提交" data-options="modal:true,closed:true,iconCls:'icon-save'"
    ...
    <iframe id="frameframe" src="<%=path%>/page/fwsManager/fwsadd.jsp" style="width: 100%; height: 100%"></iframe>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn_add").bind({
            click: function () {
            	$("#frameframe").attr("src","<%=path%>/page/fwsManager/fwsadd.jsp");
                $('#w').window('open');
            }
        });
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#frameframe").attr("src","<%=path%>/oni/fwsEdit.action?fws.tid="+selectId);
           	                $('#w').window('open');
           		       }
           			});
           		}
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#queryForm").attr("action","<%=path %>/oni/fwsDeleteDone.action?fws.tid="+selectId);
           		        	$("#queryForm").submit();
           		       }
           			});
           		}
