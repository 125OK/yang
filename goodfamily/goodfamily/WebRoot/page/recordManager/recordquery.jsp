...
<form id="queryForm" action="<%=path %>/oni/recordQuery.action" method="post">

	<s:if test="%{record.beginIndex!=null}">
 		<input type="hidden" id="beginIndex" value='<s:property value="record.beginIndex"/>' name="record.beginIndex"/>
	</s:if>
 	<s:else>
 		<input type="hidden" id="beginIndex" value='1' name="record.beginIndex"/>
 	</s:else>
    ...
    <div class="box span10 oh">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="list_table CRZ" id="CRZ0">
            ...
            <tr>
                ...
                <th style="width: 100px;">客户编码</th>
                                                
                <th style="width: 100px;">服务师编号</th>
                                                
                <th style="width: 100px;">地址</th>
                                                
                <th style="width: 100px;">服务项</th>
                                                
                <th style="width: 100px;">服务时间</th>
                                                
                <th style="width: 100px;">总时间</th>
                                                
                <th style="width: 100px;">客户意见</th>
                                                
                <th style="width: 100px;">客户签字</th>
                                                
                <th style="width: 100px;">财产确认</th>
                                     
            </tr>
            <s:iterator value="recordList" id="record">
           	<tr class="tr" style="background-color: rgb(255, 255, 255);">
                <td class="td_center"><input type="checkbox" name="selectCheckbox" value='<s:property value="#record.tid"/>'></td>
                                                                
                <td><s:property value="#record.kehuId"></s:property></td>
                                                
                <td><s:property value="#record.fwsId"></s:property></td>
                                                
                <td><s:property value="#record.address"></s:property></td>
                                                
                <td><s:property value="#record.project"></s:property></td>
                                                
                <td><s:property value="#record.fwsj"></s:property></td>
                                                
                <td><s:property value="#record.fwhouse"></s:property></td>
                                                
                <td><s:property value="#record.kehuyj"></s:property></td>
                                                
                <td><s:property value="#record.kehuqz"></s:property></td>
                                                
                <td><s:property value="#record.qr"></s:property></td>
...
<div id="w" class="easyui-window" title="表单提交" data-options="modal:true,closed:true,iconCls:'icon-save'"
    ...
    <iframe id="frameframe" src="<%=path%>/page/recordManager/recordadd.jsp" style="width: 100%; height: 100%"></iframe>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btn_add").bind({
            click: function () {
            	$("#frameframe").attr("src","<%=path%>/page/recordManager/recordadd.jsp");
                $('#w').window('open');
            }
        });
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#frameframe").attr("src","<%=path%>/oni/recordEdit.action?record.tid="+selectId);
           	                $('#w').window('open');
           		       }
           			});
           		}
           		...
           		}else if(selectCount>1)
           		{
           			...
           			var value=$('input:checkbox[name=selectCheckbox]:checked').each(function(i){
           		       ...
           		       if(0==i)
           		       {
           		        	...
           		        	$("#queryForm").attr("action","<%=path %>/oni/recordDeleteDone.action?record.tid="+selectId);
           		        	$("#queryForm").submit();
           		       }
           			});
           		}
