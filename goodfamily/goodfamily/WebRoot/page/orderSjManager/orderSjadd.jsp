...
<head lang="en">
  ...
  <body>
    <form class="form-horizontal" action="<%=path %>/oni/orderSjAddDone.action" method="post">
    	    	            	
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">订单编号</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="orderbId" placeholder="用户名称" name="orderSj.orderbId"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="zhouId" placeholder="用户名称" name="orderSj.zhouId"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="timebId" placeholder="用户名称" name="orderSj.timebId"/>
            </div>
        </div>
